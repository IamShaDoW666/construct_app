...
mixin _$User {
 ...
 String get id; String? get name; String get email; String? get password; String? get profile; String get role; String? get phone; List<Media>? get uploadedMedia; List<Batch>? get createdBatches; DateTime get createdAt; DateTime get updatedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is User&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.profile, profile) || other.profile == profile)&&(identical(other.role, role) || other.role == role)&&(identical(other.phone, phone) || other.phone == phone)&&const DeepCollectionEquality().equals(other.uploadedMedia, uploadedMedia)&&const DeepCollectionEquality().equals(other.createdBatches, createdBatches)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,password,profile,role,phone,const DeepCollectionEquality().hash(uploadedMedia),const DeepCollectionEquality().hash(createdBatches),createdAt,updatedAt);

@override
String toString() {
  return 'User(id: $id, name: $name, email: $email, password: $password, profile: $profile, role: $role, phone: $phone, uploadedMedia: $uploadedMedia, createdBatches: $createdBatches, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String? name, String email, String? password, String? profile, String role, String? phone, List<Media>? uploadedMedia, List<Batch>? createdBatches, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? email = null,Object? password = freezed,Object? profile = freezed,Object? role = null,Object? phone = freezed,Object? uploadedMedia = freezed,Object? createdBatches = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
...
as String?,uploadedMedia: freezed == uploadedMedia ? _self.uploadedMedia : uploadedMedia // ignore: cast_nullable_to_non_nullable
as List<Media>?,createdBatches: freezed == createdBatches ? _self.createdBatches : createdBatches // ignore: cast_nullable_to_non_nullable
...
class _User implements User {
  const _User({required this.id, this.name, required this.email, this.password, this.profile, required this.role, this.phone, final  List<Media>? uploadedMedia, final  List<Batch>? createdBatches, required this.createdAt, required this.updatedAt}): _uploadedMedia = uploadedMedia,_createdBatches = createdBatches;
...
@override final  String? phone;
 final  List<Media>? _uploadedMedia;
@override List<Media>? get uploadedMedia {
  final value = _uploadedMedia;
 ...
 final  List<Batch>? _createdBatches;
@override List<Batch>? get createdBatches {
  final value = _createdBatches;
  if (value == null) return null;
  if (_createdBatches is EqualUnmodifiableListView) return _createdBatches;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _User&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.profile, profile) || other.profile == profile)&&(identical(other.role, role) || other.role == role)&&(identical(other.phone, phone) || other.phone == phone)&&const DeepCollectionEquality().equals(other._uploadedMedia, _uploadedMedia)&&const DeepCollectionEquality().equals(other._createdBatches, _createdBatches)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,password,profile,role,phone,const DeepCollectionEquality().hash(_uploadedMedia),const DeepCollectionEquality().hash(_createdBatches),createdAt,updatedAt);
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = freezed,Object? email = null,Object? password = freezed,Object? profile = freezed,Object? role = null,Object? phone = freezed,Object? uploadedMedia = freezed,Object? createdBatches = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_User(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
...
as String?,role: null == role ? _self.role : role // ignore: cast_nullable_to_non_nullable
as String,phone: freezed == phone ? _self.phone : phone // ignore: cast_nullable_to_non_nullable
as String?,uploadedMedia: freezed == uploadedMedia ? _self._uploadedMedia : uploadedMedia // ignore: cast_nullable_to_non_nullable
as List<Media>?,createdBatches: freezed == createdBatches ? _self._createdBatches : createdBatches // ignore: cast_nullable_to_non_nullable
as List<Batch>?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
...
mixin _$Media {
 ...
 String get id; String? get title; String get type; String get url;// required String? description,
 User? get uploadedUser; String? get uploadedUserId; String? get reference; String? get batchId; Batch? get batch; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,type,url,uploadedUser,uploadedUserId,reference,batchId,batch,createdAt,updatedAt);

@override
String toString() {
  return 'Media(id: $id, title: $title, type: $type, url: $url, uploadedUser: $uploadedUser, uploadedUserId: $uploadedUserId, reference: $reference, batchId: $batchId, batch: $batch, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String? title, String type, String url, User? uploadedUser, String? uploadedUserId, String? reference, String? batchId, Batch? batch, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of Media
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = freezed,Object? type = null,Object? url = null,Object? uploadedUser = freezed,Object? uploadedUserId = freezed,Object? reference = freezed,Object? batchId = freezed,Object? batch = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
class _Media implements Media {
  const _Media({required this.id, required this.title, required this.type, required this.url, required this.uploadedUser, required this.uploadedUserId, required this.reference, required this.batchId, required this.batch, required this.createdAt, required this.updatedAt});
...
/// Create a copy of Media
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = freezed,Object? type = null,Object? url = null,Object? uploadedUser = freezed,Object? uploadedUserId = freezed,Object? reference = freezed,Object? batchId = freezed,Object? batch = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_Media(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: freezed == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String?,type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of Batch
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? reference = freezed,Object? userId = null,Object? createdBy = freezed,Object? media = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,reference: freezed == reference ? _self.reference : reference // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of Batch
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = freezed,Object? reference = freezed,Object? userId = null,Object? createdBy = freezed,Object? media = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_Batch(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,reference: freezed == reference ? _self.reference : reference // ignore: cast_nullable_to_non_nullable
